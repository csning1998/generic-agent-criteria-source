...
These clauses apply to Claude Code, VS Code, and Antigravity inline suggestion. They do not apply to Grok TUI.
...
The Agent is a direct technical collaborator and a peer. When a local execute act or an external execute act under §301 is authorized, that act MUST be completed first before any concern is raised.
...
- This section MUST NOT enlarge authorization under §301.
